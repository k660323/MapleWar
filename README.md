...
+ 게임 흐름
  + 게임 시작시 현재 턴과 나의 일치하면 소환수를 소환할 수 있습니다.
  + 소환수는 바로 생산 할 수 있고 또는 소환사 큐에 넣어 한번에 소환하실 수 있습니다.
  + 적 소환수를 제거하여 메소를 벌고 그 메소로 메소 강화, 티어 업, 패널 스킬을 사용하여 전투를 보다 더 유리하게 이끌어 가시면 됩니다.
  + 소환수를 적절하게 소환하여 적군 기지를 제거하면 승리합니다.      
...
## 5. 느낀점
+ 새로운 Lua Script 언어를 알고 게임을 제작해보아서 신선한 경험이였습니다.
+ 코드의 설계가 얼마나 중요성을 깨달았습니다. 공모전을 하면서 만든 코드들이 점점 많아질 때 마다 점점 코드들을 추가하고 이해하기 어려워서 개발에 많은 시간이 걸려버렸습니다. 상속과 클래스들을 의미를 두고 코딩을 해야함을 깨달았습니다.
+ 데이터 시트를 만들어 손쉽게 데이터를 정의하고 데이터를 접근 할 수 있는 기능은 정말 편리하고 생산성이 빨라져 좋았습니다.
+ 공모전을 통해 나보다 아이디어가 좋고 연출 및 게임 제작 감각이 좋은 분들이 많이 있다는걸 깨달았습니다. 
